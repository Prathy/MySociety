...
class InAppUpdate(activity: Activity) : InstallStateUpdatedListener {
    ...
    private val inAppUpdateRequestCode = 500
    ...
    private fun startUpdate(info: AppUpdateInfo, type: Int) {
        appUpdateManager.startUpdateFlowForResult(info, type, parentActivity, inAppUpdateRequestCode)
        currentType = type
    }
    ...
    private fun flexibleUpdateDownloadCompleted() {
        Snackbar.make(
            parentActivity.findViewById(R.id.login),
